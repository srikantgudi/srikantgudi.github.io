...
<style>
	...
	.sectiontitle {
		...
		padding: 4px 10px;
		margin-bottom: 4px;
		background: linear-gradient(to right,darkblue 50%,lightblue);
		color: #ffffff;
	}
	.skills {
	...
	<div class="content">
		<div class="panel">
			...
			<div class="profile-details">
				<ul>
					...
					<li>Interested in frontend architecture and providing solutions as independent developer</li>
				</ul>
			</div>
		</div>
		<div class="panel">
			...
			<div class="contact-details">
				...
				<div>
					<a href="https://www.linkedin.com/in/srikantgudi-blr/">LinkedIN profile</a>
				</div>
				<div>
					Skype: srikantgudi
				</div>
		...
		<div class="panel">
			...
			<div>
				...
				<SkillLevel width={450} ht={30} text={skill} level={data.skills[skill]} />
				{/each}
			</div>
		</div>
		<div class="panel exp">

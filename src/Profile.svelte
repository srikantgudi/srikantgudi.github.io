<div class="section">
    ...
    <ul>
        ...
        <li>
            April 2014 onwards: into Front-end development using Angular, Svelte, Stencil, React, NodeJS
        </li>
        <li>
        ...
        <li>
          Have knowledge of Web components development, VueJS, NuxtJS, NextJS, MongoDB
        </li>
    </ul>
</div>

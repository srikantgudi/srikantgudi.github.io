  ...
  let expList = [
    ...
    },
    {
      header: {
        ...
        org:
          'Tejas Systems / SUNSYSTEMS, Bengaluru :: Client: MModal Global Services Pvt Ltd',
      },
      content: [
    ...
    {
      header: {
        dates: '10-Feb-2010 – 22-Sep-2011',
        jobTitle: 'Senior Software Engineer',
        org: 'TechJini Solutions Pvt Ltd, Bengaluru',
      },
      content: [
    ...
    {
      header: {
        dates: '25-Jul-2007 – 13-Mar-2009',
        jobTitle: 'Senior Software Engineer',
        org: 'TLI Software Pvt Ltd, Bengaluru',
      },
      content: [
    ...
    {#each expList as exp}
      <Panel hdrbg="#333333" showcontent={curExp === exp}>
        <div slot="header" on:click={() => (curExp = exp)}>
          ...
          <div class="subtitle">{exp.header.org}</div>
        </div>
        <div slot="content">
          <ul>
